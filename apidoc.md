...
|:----------:|----------|
| Type | GET |
| Response | <ul><li>No errors: Status 200 and items that matched the query</li><li>No permission: Status 403</li><li>Errors: Status 500</li></ul> |
...
|:----------:|----------|
| Type | GET |
| Response | <ul><li>No errors: Status 200 and requested sections</li><li>No permission???}: Status 403</li><li>Errors: Status 500</li></ul> |
...
|:----------:|----------|
| Type | GET |
| Response | <ul><li>No errors: Status 200 and requested logs</li><li>No permission: Status 403</li><li>Errors: Status 500</li></ul> |
...
| Type | POST |
| Body | `{'sectionId': integer}` |
| Response | <ul><li>No errors: Status 200 and requested files</li><li>Error querying data: Status 400</li><li>Errors: Status 500</li></ul> |
