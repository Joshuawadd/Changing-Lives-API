...
test('other path', function (t) {
    ...
    resolve(***REMOVED***, { basedir: dir, paths: [otherDir] }, function (err, res) {
        if (err) t.fail(err);
    ...
    resolve(***REMOVED***, { basedir: dir }, function (err, res) {
        t.equal(err.message, "Cannot find module ***REMOVED*** from '" + path.resolve(dir) + "'");
        t.equal(err.code, 'MODULE_NOT_FOUND');
    });
